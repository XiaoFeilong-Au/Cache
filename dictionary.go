...
func query(word string) {
	...
	if resp.StatusCode != 200{
		log.Fatal("bad stat",resp.StatusCode,"body",string(bodyText))
	}
	...
	fmt.Println(word ,"UK",dict.Dictionary.Prons.En,"US:",dict.Dictionary.Prons.EnUs)
	for _,i := range dict.Dictionary.Explanations{
		fmt.Println(i)
	}
